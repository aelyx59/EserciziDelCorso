...
public class InputDati {
    ...
    private static final String ERRORE_MINIMO = "Attenzione: e' richiesta un'eta' maggiore o uguale a ";
    private static final String ERRORE_STRINGA_VUOTA = "Attenzione: non hai inserito alcun carattere";
    private static final String ERRORE_MASSIMO = "Attenzione: e' richiesta un'et' minore o uguale a  ";
